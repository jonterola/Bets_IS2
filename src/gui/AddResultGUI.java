...
public class AddResultGUI extends JFrame {
	...
	private JButton jButtonClose = new JButton(ResourceBundle.getBundle("Etiquetas").getString("AddResult")); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public AddResultGUI(Registro user2) {
		user = user2;
		try {
			jbInit();
		} catch (Exception e) {
	...
	private void jbInit() throws Exception {
		...
		JLabel lblPronostico = new JLabel(ResourceBundle.getBundle("Etiquetas").getString("Result")); //$NON-NLS-1$ //$NON-NLS-2$
